...
`,Pe=({children:e,hidebackground:t,extendChildContainer:n,isMatch:r})=>{const[o,i]=A.useState(null),s=le.get("role");!s&&Gx.includes(String(window.location.pathname.split("/")[1]).toLowerCase())&&(window.location.href="/login"),A.useEffect(()=>{(async()=>{try{const d=await Hv();i(d==null?void 0:d.data)}catch(d){console.log(d)}})()},[]);const l=()=>{le.remove("username"),le.remove("token"),le.remove("role"),window.location.href="/"},a=()=>{window.location.href="/login"},u=Yh(s);return f.jsxs(Xx,{hidebackground:t,isMatch:r,children:[f.jsx(Yx,{items:u,title:`Hi! ${(o==null?void 0:o.name)||""}`,isLogged:!!s,handleLogin:a,handleLogout:l}),f.jsxs(Jx,{children:[f.jsx(iw,{onClick:()=>{window.location.href="/"},src:"https://oncolympics-assets.expression-egy.com/assets/image/Oncolympics Logo.png",alt:"Oncolympics_Logo"}),f.jsxs(Zx,{children:[u==null?void 0:u.map((c,d)=>f.jsx(ew,{exact:!0,to:c.route,activeClassName:"active",children:c.label},d)),!s&&f.jsx(tw,{onClick:a,children:"Login"}),!!s&&f.jsxs(rw,{children:[o?f.jsxs(Rf,{children:[f.jsx(Pf,{children:`Hi! ${o==null?void 0:o.name}`}),!!o.logo&&f.jsx(ow,{src:`https://oncolympics-assets.expression-egy.com/assets/teamslogos/${o==null?void 0:o.logo}`,alt:"user_logo"})]}):f.jsx(Rf,{children:f.jsx(Pf,{children:". . ."})}),o&&f.jsx(nw,{id:"logout",onClick:l,children:"Logout"})]})]})]}),f.jsx(sw,{extendChildContainer:n,children:e})]})},lw=v.div`
  display: flex;
  justify-content: center;
  align-items: center;
...
`,Yw=({isOpen:e,onClose:t,match:n})=>{const[r,o]=A.useState(null),[i,s]=A.useState(!0),[l,a]=A.useState(null);return A.useEffect(()=>{e?(async()=>{s(!0);try{const c=await yw(n==null?void 0:n.matchId);o(c),s(!1)}catch(c){a(c),s(!1)}})():o(null)},[e,n]),i?f.jsx(Bf,{children:f.jsx(Hf,{children:"Loading..."})}):l?f.jsx(Bf,{children:f.jsxs(Hf,{children:["Error: ",l.message]})}):f.jsx(km,{isOpen:e,onClose:t,children:f.jsxs("div",{children:[f.jsx(Bw,{children:f.jsx(Hw,{children:"Match Details"})}),f.jsxs(qw,{children:[f.jsx(wn,{match:{...n,match_status:n==null?void 0:n.matchStatus,team1_name:n==null?void 0:n.team1,team1_logo:n==null?void 0:n.team1Logo,score_team1:n==null?void 0:n.team1Score,team2_name:n==null?void 0:n.team2,team2_logo:n==null?void 0:n.team2Logo,score_team2:n==null?void 0:n.team2Score}}),f.jsx(Kw,{children:r==null?void 0:r.map((u,c)=>f.jsxs(Ww,{children:[f.jsxs(Vw,{children:["Question ",u.questionId+1]}),f.jsxs(Qw,{children:[f.jsxs(Wf,{children:[f.jsxs(Vf,{children:[u.team1_name,":"]})," ",f.jsx(Qf,{children:u.score_team1})]}),f.jsxs(Wf,{children:[f.jsx(Qf,{children:u.score_team2})," ",f.jsxs(Vf,{children:[":",u.team2_name]})]})]})]},c))})]})]})})},Gw=v.div`
...
`,Zw=v.div`
  ...
  line-height: 18px;
`,eS=()=>{const[e,t]=A.useState(!1),[n,r]=A.useState(null),[o,i]=A.useState([]),[s,l]=A.useState(!0),[a,u]=A.useState(null);if(A.useEffect(()=>{const d=async()=>{try{const w=await gw();i(w),l(!1)}catch(w){console.log(w),u("Failed to fetch data"),l(!1)}};d();const m=setInterval(d,1e4);return()=>clearInterval(m)},[]),s&&!(o!=null&&o.length))return f.jsx(Kf,{children:f.jsx(qf,{children:"Loading ..."})});if(a)return f.jsx(Kf,{children:f.jsx(qf,{children:a})});const c=d=>{r(d),t(!0)};return f.jsxs(Pe,{children:[f.jsx(Gw,{children:o==null?void 0:o.map((d,m)=>f.jsxs(Xw,{children:[f.jsxs("div",{style:{display:"flex",flexDirection:"column",width:"100%"},children:[f.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"10px"},children:[f.jsx(Tr,{style:{width:"40%",textAlign:"center"},children:d.team1})," vs ",f.jsx(Tr,{style:{width:"40%",textAlign:"center"},children:d.team2})]}),f.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"10px"},children:[f.jsx(Tr,{children:d.team1Score})," : ",f.jsx(Tr,{children:d.team2Score})]}),f.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"10px",marginTop:"5px"},children:[f.jsxs(Tr,{children:[d.matchStatus===0&&"Not Started Yet",d.matchStatus===1&&"Live Now",d.matchStatus===2&&"Ended"]}),d.matchStatus!==0&&f.jsx(Zw,{onClick:()=>c(d),children:f.jsx("p",{style:{margin:"0"},children:"Details"})})]})]}),f.jsx(Jw,{children:d.date})]},m))}),e&&f.jsx(Yw,{match:n,isOpen:e,onClose:()=>t(!1)})]})},tS=async()=>{var e;try{return(e=(await B.get(_e.playermatch,{headers:{token:le.get("token")}})).data.data)==null?void 0:e[0]}catch(t){return console.log(t),""}},nS=async(e,t)=>{try{await B.post(_e.answer,{answer:e,answerId:t},{headers:{token:le.get("token")}})}catch(n){return console.log(n),""}};v.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  padding: 2rem;
...
`;v(Rm)``;const ut={0:"a. ",1:"b. ",2:"c. ",3:"d. "},rS=v.div`
    padding: 40px;
`,oS=v.div`
    margin-bottom: 1.5rem;
`,iS=v.p`
...
`,pS=({questionFile:e,currentQuestion:t,answerQuestion:n,match:r,matchDetails:o})=>{var y;const[i,s]=A.useState([]),[l,a]=A.useState(null),[u,c]=A.useState(),d=r==null?void 0:r.canAnswer;if(A.useEffect(()=>{c(null)},[t]),A.useEffect(()=>{(async()=>{try{const h=await(await fetch(`https://oncolympics-assets.expression-egy.com/assets/matchesquestions/${e}`)).json();s(h.questions)}catch(C){a(C)}})()},[e]),l)return f.jsxs("div",{children:["Error: ",l.message]});const m=i[t],w=(x,C)=>{d&&(n(x,C),c(C))};return f.jsxs(rS,{children:[f.jsxs(fS,{children:[f.jsxs("div",{style:{width:"100%"},children:[f.jsx(uS,{children:`${t+1} / ${i==null?void 0:i.length}`}),f.jsx(oS,{children:f.jsx(iS,{children:m==null?void 0:m.question})})]}),f.jsx(dS,{children:o})]}),f.jsx(cS,{children:m==null?void 0:m.answers.map((x,C)=>f.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:f.jsx(sS,{onClick:()=>w(x.correct,C),isSelected:C===u,isRight:x.correct&&!d,isWrong:!x.correct&&!d&&C===u,children:f.jsx(lS,{children:`${ut[C]}${x.answer}`})},C)},C))}),!d&&f.jsx(aS,{children:`${ut[m==null?void 0:m.answers.findIndex(x=>x==null?void 0:x.correct)]}${(y=m==null?void 0:m.answers.find(x=>x==null?void 0:x.correct))==null?void 0:y.reason}`})]})},hS=()=>{const[e,t]=A.useState(null),[n,r]=A.useState(null),o=async(s,l)=>{await nS(s,l)};if(A.useEffect(()=>{const s=async()=>{try{const a=await tS();t(a?[a]:null)}catch(a){r(a)}};s();const l=setInterval(s,4e3);return()=>clearInterval(l)},[e]),n)return f.jsx(Pe,{isMatch:!0,children:f.jsx(Yf,{children:f.jsxs(Gf,{children:["Error: ",n.message]})})});if((e==null?void 0:e.length)===0||e===null)return f.jsx(Pe,{isMatch:!0,children:f.jsx(Yf,{children:f.jsx(Gf,{children:"No Matches Yet"})})});const i=e==null?void 0:e[0];if((i==null?void 0:i.match_status)===0)return f.jsx(Pe,{isMatch:!0,children:f.jsx("div",{children:f.jsx(wn,{match:i})})});if((i==null?void 0:i.match_status)===1)return f.jsx(Pe,{isMatch:!0,children:f.jsx(Rm,{children:f.jsx("div",{children:f.jsx(pS,{match:i,answerQuestion:o,questionFile:i==null?void 0:i.question_file,currentQuestion:i==null?void 0:i.current_question,matchDetails:f.jsx(wn,{match:i})})})})});if((i==null?void 0:i.match_status)===2)return f.jsx(Pe,{isMatch:!0,children:f.jsx("div",{children:f.jsx(wn,{match:i})})})},mS=async()=>{var e;try{const t=await B.get(_e.moderatormatch,{headers:{token:le.get("token")}});return(e=t==null?void 0:t.data)==null?void 0:e.data}catch(t){return console.log(t),""}},gS=async()=>{try{await B.get(_e.startmatch,{headers:{token:le.get("token")}})}catch(e){return console.log(e),""}},yS=async()=>{try{await B.get(_e.nextquestion,{headers:{token:le.get("token")}})}catch(e){return console.log(e),""}},vS=async()=>{try{await B.get(_e.endmatch,{headers:{token:le.get("token")}})}catch(e){return console.log(e),""}},xS=async()=>{try{return await B.get(_e.stopanswer,{headers:{token:le.get("token")}})}catch(e){return console.log(e),""}},wS=async()=>{try{return await B.get(_e.resetmatch,{headers:{token:le.get("token")}})}catch(e){return console.log(e),""}},SS=async e=>{try{await B.post(_e.reward,{teamId:e},{headers:{token:le.get("token")}})}catch(t){return console.log(t),""}},kS=async e=>{try{await B.post(_e.penalty,{teamId:e},{headers:{token:le.get("token")}})}catch(t){return console.log(t),""}},ES=async(e,t)=>{var n;try{const r=await B.get(`${_e.questionanswers}?matchId=${e}&questionId=${t}`,{headers:{token:le.get("token")}});return(n=r==null?void 0:r.data)==null?void 0:n.data}catch(r){return console.log(r),""}},CS=v.div`
    margin-bottom: 1.5rem;
`,jS=v.p`
    font-size: 32px;
    text-align: center;
...
`,TS=v.div`
    ...
    margin: 0 auto;
    box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);
`,OS=({isOpen:e,onClose:t,match:n})=>{const{question_file:r,team1_name:o,team2_name:i,team1_logo:s,team2_logo:l,current_question:a,id:u}=n,[c,d]=A.useState(null),[m,w]=A.useState(null),[y,x]=A.useState(!1),[C,h]=A.useState(null);return A.useEffect(()=>{e?(async()=>{var g,S,_,k,j;try{const b=await(await fetch(`https://oncolympics-assets.expression-egy.com/assets/matchesquestions/${r}`)).json(),z=(g=b==null?void 0:b.questions)==null?void 0:g[a],Q=await ES(u,a);let we=(S=z==null?void 0:z.answers)==null?void 0:S[Q==null?void 0:Q.team1answerid],Ue=(ut==null?void 0:ut[Q==null?void 0:Q.team1answerid])||"";we={...we,answer:`${Ue}${(we==null?void 0:we.answer)||""}`};let Se=(_=z==null?void 0:z.answers)==null?void 0:_[Q==null?void 0:Q.team2answerid],gt=(ut==null?void 0:ut[Q==null?void 0:Q.team2answerid])||"";Se={...Se,answer:`${gt}${(Se==null?void 0:Se.answer)||""}`};let Ge=(k=z==null?void 0:z.answers)==null?void 0:k.find(T=>T.correct),ot=ut[(j=z==null?void 0:z.answers)==null?void 0:j.findIndex(T=>T.correct)];Ge={...Ge,answer:`${ot}${Ge.answer}`},h(Ge),d(we),w(Se),x(!0)}catch(P){console.log(P)}})():(d(null),w(null),x(!1),h(null))},[a,u,e,n,r]),f.jsx(km,{isOpen:e,onClose:t,children:f.jsxs("div",{children:[f.jsx(CS,{children:f.jsx(jS,{children:"Teams answers"})}),f.jsxs(_S,{children:[f.jsx(Zf,{children:f.jsxs("div",{children:[f.jsx(Xf,{src:`https://oncolympics-assets.expression-egy.com/assets/teamslogos/${s}`,alt:"team1_logo"}),f.jsx(Jf,{children:o}),y?f.jsx("div",{children:f.jsx(ya,{isRight:c==null?void 0:c.correct,isWrong:!(c!=null&&c.correct),children:(c==null?void 0:c.answer)||"N/A"})}):""]})}),f.jsx(Zf,{children:f.jsxs("div",{children:[f.jsx(Xf,{src:`https://oncolympics-assets.expression-egy.com/assets/teamslogos/${l}`,alt:"team2_logo"}),f.jsx(Jf,{children:i}),y?f.jsx("div",{children:f.jsx(ya,{isRight:m==null?void 0:m.correct,isWrong:!(m!=null&&m.correct),children:(m==null?void 0:m.answer)||"N/A"})}):""]})})]}),C&&f.jsxs(TS,{children:[f.jsxs("div",{style:{display:"flex",gap:"0px"},children:[f.jsx(Ru,{isRight:!0,children:"Right Answer:"}),f.jsx(RS,{style:{margin:"15px 0"},isRight:!0,children:C.answer})]}),f.jsx(PS,{isRight:!0,children:C.reason})]})]})})};v.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  padding: 2rem;
...
`,HS=v.img`
    ...
    cursor: pointer;
    margin: 0px 30px;
`,WS="/assets/play-button-BnJzDZ_o.png",VS="/assets/pause-button-B4y1qv28.png",QS=v.div`
  display: flex;
  gap: 10px;
`,KS=v.div`
  font-size: 28px;
...
`,nd=v.img`
    ...
    height: 40px;
    cursor: pointer;
`,qS=({isChanged:e,stopCounter:t})=>{const[n,r]=A.useState(60),[o,i]=A.useState(!1);return A.useEffect(()=>{if(n>0&&o){const s=setInterval(()=>{r(l=>l-1)},1e3);return()=>clearInterval(s)}},[n,o]),A.useEffect(()=>{r(t?0:60)},[e,t]),f.jsxs(QS,{children:[f.jsx(KS,{children:`${n===0?"Timeout!":`${n} sec`}`}),o?f.jsx(nd,{onClick:()=>i(!o),src:VS,alt:"PauseImg"}):f.jsx(nd,{onClick:()=>i(!o),src:WS,alt:"PlayImg"})]})},YS=({toggleDetailsPopUp:e,teamCanAnswer:t,stopAnswer:n,matchDetails:r,questionFile:o,currentQuestion:i,setNumberOfQuestions:s})=>{var p,g;console.log(r);const[l,a]=A.useState([]),[u,c]=A.useState(!0),[d,m]=A.useState(null),[w,y]=A.useState(!1),[x,C]=A.useState(!1);if(A.useEffect(()=>{y(!1),C(!1)},[i]),A.useEffect(()=>{(async()=>{var _;try{const j=await(await fetch(`https://oncolympics-assets.expression-egy.com/assets/matchesquestions/${o}`)).json();a(j.questions),s((_=j==null?void 0:j.questions)==null?void 0:_.length),c(!1)}catch(k){m(k),c(!1)}})()},[o,s]),u)return f.jsx("div",{children:"Loading..."});if(d)return f.jsxs("div",{children:["Error: ",d.message]});const h=l[i];return f.jsxs($S,{children:[f.jsxs(US,{children:[f.jsxs("div",{style:{width:"100%"},children:[f.jsxs("div",{style:{display:"flex"},children:[f.jsx(IS,{children:`${i+1} / ${l==null?void 0:l.length}`}),f.jsxs("div",{style:{margin:"0 auto",display:"flex",justifyContent:"center"},children:[f.jsx("div",{style:{width:"145px"},children:f.jsx(qS,{isChanged:i,stopCounter:x})}),t&&f.jsx(HS,{onClick:()=>{n(),C(!0)},src:"https://oncolympics-assets.expression-egy.com/assets/image/stopwatch.png",alt:"stopwatch"})]})]}),f.jsx(NS,{children:f.jsx(LS,{children:h==null?void 0:h.question})})]}),f.jsx(BS,{children:r})]}),f.jsx(bS,{children:h==null?void 0:h.answers.map((S,_)=>f.jsx("div",{children:f.jsx(AS,{isRight:S.correct&&w,children:f.jsx(zS,{children:`${ut[_]}${S.answer}`})},_)},_))}),w&&f.jsx(MS,{children:`${ut[(p=h==null?void 0:h.answers)==null?void 0:p.findIndex(S=>S==null?void 0:S.correct)]} ${(g=h==null?void 0:h.answers.find(S=>S==null?void 0:S.correct))==null?void 0:g.reason}`}),f.jsx(DS,{onClick:()=>{y(!0),e(!0)},children:f.jsx(FS,{children:"Show Right Answer"})})]})},GS=()=>{const[e,t]=A.useState(!1),[n,r]=A.useState(null),[o,i]=A.useState(!0),[s,l]=A.useState(null),[a,u]=A.useState(0),[c,d]=A.useState(void 0),[m,w]=A.useState(void 0),y=async()=>{i(!0);try{const P=await mS();r(P),i(!1),d(void 0),w(void 0)}catch(P){l(P),i(!1)}};A.useEffect(()=>{y()},[]);const x=async()=>{i(!0);try{await gS(),y()}catch(P){console.error(P)}},C=async()=>{w(!0);try{await yS(),y()}catch(P){console.error(P)}},h=async()=>{try{await xS().then(()=>{y()})}catch(P){console.error(P)}},p=async()=>{try{await vS(),y()}catch(P){console.error(P)}},g=async()=>{d(!0);try{await wS().then(()=>{y()})}catch(P){console.error(P)}},S=async P=>{try{await SS(P).then(()=>y())}catch(b){console.error(b)}},_=async P=>{try{await kS(P).then(()=>y())}catch(b){console.error(b)}};if(s)return f.jsx(Pe,{isMatch:!0,children:f.jsx(ed,{children:f.jsxs(td,{children:["Error: ",s.message]})})});if((n==null?void 0:n.length)===0)return f.jsx(Pe,{isMatch:!0,children:f.jsx(ed,{children:f.jsx(td,{children:"No Matches Yet"})})});const k=n==null?void 0:n[0],j=(k==null?void 0:k.canAnswer)===1;if((k==null?void 0:k.match_status)===0)return f.jsx(Pe,{isMatch:!0,children:f.jsxs("div",{children:[f.jsx(wn,{isAdmin:!0,match:k}),f.jsx(ll,{id:"panel",children:f.jsx(Or,{onClick:x,children:f.jsx($r,{children:o?"Loading":"Start Match"})})})]})});if((k==null?void 0:k.match_status)===1)return f.jsxs(Pe,{isMatch:!0,children:[f.jsx(Pm,{children:f.jsxs("div",{children:[f.jsx(YS,{toggleDetailsPopUp:t,teamCanAnswer:j,stopAnswer:h,setNumberOfQuestions:u,questionFile:k==null?void 0:k.question_file,currentQuestion:k==null?void 0:k.current_question,matchDetails:f.jsx(wn,{isAdmin:!0,match:k,rewardTeam:S,penaltyTeam:_})}),f.jsxs(ll,{id:"panel",children:[a===(k==null?void 0:k.current_question)+1?f.jsx("div",{children:!j&&f.jsx(Or,{onClick:p,children:f.jsx($r,{children:"End Match"})})}):f.jsx("div",{children:!j&&f.jsx(Or,{onClick:C,children:f.jsx($r,{children:m?"Loading ...":"Next"})})}),f.jsx(Or,{onClick:g,children:f.jsx($r,{children:c?"Resetting ...":"Reset"})})]})]})}),e&&f.jsx(OS,{match:k,isOpen:e,onClose:()=>t(!1)})]});if((k==null?void 0:k.match_status)===2)return f.jsx(Pe,{isMatch:!0,children:f.jsxs("div",{children:[f.jsx(wn,{isAdmin:!0,match:k}),f.jsx(ll,{id:"panel",BtnsPanel:!0,children:f.jsx(Or,{onClick:g,children:f.jsx($r,{children:c?"Resetting ...":"Reset Match"})})})]})})},XS=v.div`
  display: flex;
  padding: 60px 0;
`,JS=v.img`
    width: 70%;
    margin: auto;
`,ZS=()=>f.jsx(Pe,{children:f.jsx(XS,{children:f.jsx(JS,{src:"https://oncolympics-assets.expression-egy.com/assets/image/knockouts.png",alt:"knockouts"})})}),ek=v.div`
...
`;const ok=()=>{const e=Yh();return f.jsx(ek,{children:f.jsx("div",{style:{display:"flex",justifyContent:"space-between"},children:f.jsxs(tk,{children:[f.jsx(rk,{src:"https://oncolympics-assets.expression-egy.com/assets/image/Oncolympics Logo.png",alt:"Oncolympics_Logo"}),e==null?void 0:e.map((t,n)=>f.jsx(nk,{exact:!0,to:t.route,activeClassName:"active",children:t.label},n))]})})})},ik=Co`
  position: absolute;
  margin-top: unset;
  width: 100%;
`;v.div`
...
`;const ak=()=>{const e=A.useRef(null);return f.jsxs(f.Fragment,{children:[f.jsx(sk,{children:f.jsx(Pe,{hidebackground:!0,extendChildContainer:ik,children:f.jsx("div",{children:f.jsxs("video",{ref:e,poster:"https://oncolympics-assets.expression-egy.com/assets/image/landing.png",autoPlay:!0,loop:!0,muted:!0,style:{width:"100%",height:"auto"},children:[f.jsx("source",{src:"https://oncolympics-assets.expression-egy.com/assets/videos/landingvideo.mp4",type:"video/mp4"}),"Your browser does not support the video tag."]})})})}),f.jsx(lk,{children:f.jsx(ok,{})})]})},uk=()=>f.jsx(xh,{children:f.jsxs(mu,{children:[f.jsx(at,{exact:!0,path:"/",component:ak}),f.jsx(at,{exact:!0,path:"/login",component:cw}),f.jsx(at,{path:"/groups",component:mw}),f.jsx(at,{path:"/knockouts",component:ZS}),f.jsx(at,{path:"/schedule",component:eS}),f.jsx(at,{path:"/yourmatch",component:hS}),f.jsx(at,{path:"/matchmoderator",component:GS}),f.jsx(us,{to:"/"})]})});mh(document.getElementById("root")).render(f.jsx(uk,{}));
